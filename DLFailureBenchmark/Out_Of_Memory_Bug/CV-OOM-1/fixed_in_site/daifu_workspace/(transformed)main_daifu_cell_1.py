def main_daifu_cell_1():
    try:
        global argparse, args, cuda_kwargs, dataset1, dataset2, datasets, device, epoch, float, int, model, optim, optimizer, parser, scheduler, test_kwargs, test_loader, torch, train_kwargs, train_loader, transform, transforms, use_cuda, use_mps
