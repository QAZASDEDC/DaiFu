...
def main_daifu_rest_1():
    try:
        global batch_size, beta_schedule, callbacks, conv, datagen, epoch, f, gibbs_pruning, init, input_shape, inputs, keras, ks, kwargs, layers, lr_schedule, lr_scheduler, m, model, n_classes, n_epochs, np, opt, outputs, p, reg, s, score, test_gen, train_gen, x, x_test, x_train, y_test, y_train
        goto .restart
