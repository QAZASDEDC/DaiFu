...
code.InteractiveInterpreter(vars(gibbs_pruning)).runsource("from tensorflow.python.ops import nn", symbol='exec')
...
code.InteractiveInterpreter(vars(gibbs_pruning)).runsource(new_class_code, symbol='exec')
