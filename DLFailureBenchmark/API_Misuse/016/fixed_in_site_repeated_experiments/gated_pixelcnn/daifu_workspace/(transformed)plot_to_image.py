...
def plot_to_image(figure):
    daifu_store = {}
    for daifu_dataname in daifu.TRANSFORM_REGISTRY['plot_to_image']['dataname_list']:
    ...
    try:
        daifu_return_tag, daifu_return_item = plot_to_image_daifu_cell_1()
    except Exception:
        while True:
            try:
                daifu.RP_MANAGER.repair()
                daifu_return_tag, daifu_return_item = plot_to_image_daifu_rest_1()
                break
            except Exception:
                continue
