def main_daifu_cell_1():
    try:
        global X_test, X_train, Y_test, Y_train, batch_size, img_cols, img_rows, mnist, model, nb_classes, nb_conv, nb_epoch, nb_filters, nb_pool, np_utils, score, y_test, y_train
        batch_size = 128
        nb_classes = 10
        nb_epoch = 12
