...
for i in range(2):
    ...
    os.system("rm -rf ./daifu_workspace")
    os.system("rm -f experiment_record.log.lock")
    os.system("python main_with_daifu_normal_runs.py -a " + model_arch + " --dist-url 'tcp://127.0.0.1:9527' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1 --rank 0 --epoch 3")
