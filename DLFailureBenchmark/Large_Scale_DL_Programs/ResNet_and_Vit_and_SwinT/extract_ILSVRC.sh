...
mkdir imagenet/train && mv ../ImageNet2012/ILSVRC2012_img_train.tar imagenet/train/ && cd imagenet/train
...
mkdir imagenet/val && mv ../ImageNet2012/ILSVRC2012_img_val.tar imagenet/val/ && cd imagenet/val && tar -xvf ILSVRC2012_img_val.tar && rm -f ILSVRC2012_img_val.tar
